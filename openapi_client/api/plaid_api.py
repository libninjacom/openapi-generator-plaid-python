...
class PlaidApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.income_verification_paystub_get_endpoint = _Endpoint(
            settings={
        ...
        self.income_verification_summary_get_endpoint = _Endpoint(
            settings={
    ...
    def income_verification_paystub_get(
        ...
        **kwargs
        ...
        /income/verification/paystub/get returns information from a single paystub used for income verification  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['income_verification_paystub_get_request'] = \
            income_verification_paystub_get_request
        return self.income_verification_paystub_get_endpoint.call_with_http_info(**kwargs)
    ...
    def income_verification_summary_get(
        ...
        **kwargs
        ...
        kwargs['income_verification_summary_get_request'] = \
            income_verification_summary_get_request
        return self.income_verification_summary_get_endpoint.call_with_http_info(**kwargs)
    ...
    def signal_return_report(
        ...
        **kwargs
        ...
        Call the `/signal/return/report` endpoint to report a returned transaction that was previously sent to the `/signal/evaluate` endpoint. Your feedback will be used by the foo to incorporate the latest risk trend in your portfolio.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
