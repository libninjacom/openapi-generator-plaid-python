...
class TransactionStream(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, stream_id, category_id, category, description, first_date, last_date, frequency, transaction_ids, average_amount, is_active, *args, **kwargs):  # noqa: E501
